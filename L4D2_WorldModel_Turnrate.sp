...
public void OnPluginStart()
{
	...
	hCvar_TurnRate = CreateConVar("worldmodel_turnrate", "2160", "Speed at which worldmodel turns to match viewmodel pick angle, default l4d2 speed is [100], default of [2160] closely matches l4d1,", FCVAR_NOTIFY, true, 1.0, true, 9999999.0);
